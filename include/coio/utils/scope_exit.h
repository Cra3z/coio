...
namespace coio {
	...
	public:
		template<typename Fn> requires different_from<std::remove_cvref_t<Fn>, scope_exit> and std::is_constructible_v<EF, Fn> and (std::is_nothrow_constructible_v<EF, Fn> or std::is_nothrow_constructible_v<EF, Fn&>)
		...
		template<typename Fn> requires different_from<std::remove_cvref_t<Fn>, scope_exit> and std::is_constructible_v<EF, Fn>
